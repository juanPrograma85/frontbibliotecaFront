...
import { parametrosDTO, ParametrosEAFResponse } from '../models/serGeneral/propiedades.model';
...
export class StorageService {
  ...
  actualizarPropiedadEspecifica(nombrePropiedad: any, nuevoValor:any) :void{
    var session = this.getCurrentSession();
    if (session == null) {
      // return void;
    }
